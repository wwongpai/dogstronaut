#!/usr/bin/env bash
# Trigger 10 minutes of 100% error mode across all services (all replicas), then restore normal
set -euo pipefail
...
echo ""
echo -e "${YELLOW}  Waiting 10 minutes (600s)...${NC}"
sleep 600
...
echo ""
echo -e "${GREEN}Done! 100% error mode ran for 10 minutes, all replicas restored to normal.${NC}"
