...
const ERROR_SCENARIOS = [
  ...
  {
    name: 'profile_db_connection_error',
    status: 503,
    message: 'User profile database connection failed',
  },
  {
    name: 'user_not_found_simulation',
    status: 404,
...
function setChaosMode(mode) {
  ...
  logger.info('Chaos mode updated', { mode, service: SERVICE_NAME })
}
