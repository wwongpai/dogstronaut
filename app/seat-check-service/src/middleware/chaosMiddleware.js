...
const ERROR_SCENARIOS = [
  ...
  {
    name: 'seat_check_timeout',
    status: 503,
    message: 'Seat inventory service timeout, please retry',
  },
  {
    name: 'invalid_rocket_class',
    status: 400,
    message: 'Rocket class not recognized in seat inventory system',
  },
]
