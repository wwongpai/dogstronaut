...
const ERROR_SCENARIOS = [
  {
    name: 'notification_provider_timeout',
    status: 503,
    message: 'Notification provider timed out, please retry',
  },
  {
    name: 'invalid_email',
    status: 400,
  ...
  {
    name: 'notification_quota_exceeded',
    status: 429,
    message: 'Notification quota exceeded, rate limit reached',
  },
]
