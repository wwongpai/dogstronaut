...
const ERROR_SCENARIOS = [
  {
    name: 'loyalty_sync_failed',
    status: 503,
    message: 'Loyalty database sync failed, please retry',
  },
  {
    name: 'loyalty_account_frozen',
    status: 403,
    message: 'Loyalty account is frozen due to suspicious activity',
  },
  {
    name: 'loyalty_service_unavailable',
    status: 503,
